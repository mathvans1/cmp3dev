...
<div class="top-bar">
  ...
  <div class="top-bar-left">
    ...
    $mainmenu = module_invoke('menu', 'block_view', 'main-menu');
...
<div id="header" class="hero callout large primary" style="background-image: url('img/header.jpg')">
    <div class="row">
    <div class="medium-2 columns"> <?php if ($logo): ?>
            <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home" id="logo">
                <img style="width: 75px" src="<?php print $logo; ?>" alt="<?php print t('Home'); ?>" />
            </a>
        <?php endif; ?></div>
...
<div class="row expanded">
    <div class="medium-6 columns">
        ...
        $mainmenu = module_invoke('menu', 'block_view', 'menu-footer-menu');
        print render($mainmenu['content']);
    ...
    <div class="medium-6 columns">
        ...
        $mainmenu = module_invoke('menu', 'block_view', 'menu-social-media-footer');
        print render($mainmenu['content']);
